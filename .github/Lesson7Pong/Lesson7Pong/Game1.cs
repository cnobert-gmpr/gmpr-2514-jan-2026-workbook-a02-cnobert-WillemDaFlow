...
public class Pong : Game
{
    ...
    private Brick _brickLeft, _brickRight;
    private Texture2D _pixel;
    private Ball _ball;
    private Blocker _centerBlocker;
    ...
    protected override void Initialize()
    {
        ...
        _brickLeft = new Brick();
        _brickLeft.Initialize(new Vector2(100, 100), new Vector2(20, 60), Color.Red);

        _brickRight = new Brick();
        _brickRight.Initialize(new Vector2(630, 100), new Vector2(20, 60), Color.Blue);
        
        _centerBlocker = new Blocker();
        _centerBlocker.Initialize(new Vector2(_WindowWidth / 2 - 15, _WindowHeight / 2 - 15), new Vector2(30, 30), Color.Yellow);
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        _brickLeft.Update(_ball);
        _brickRight.Update(_ball);
        _centerBlocker.Update(_ball);
    ...
    protected override void Draw(GameTime gameTime)
    {
        ...
        _brickLeft.Draw(_spriteBatch, _pixel);
        _brickRight.Draw(_spriteBatch, _pixel);
        _centerBlocker.Draw(_spriteBatch, _pixel);
